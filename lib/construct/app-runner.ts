  ...
  constructor(scope: Construct, id: string, props: ConfigStackProps) {
    ...
    */
    ...
    appRunnerInstanceRole.addToPolicy(
      new PolicyStatement({
        effect: Effect.ALLOW,
        actions: ["ssm:PutParameter", "ssm:GetParameter*", "ssm:DescribeParameters"],
        resources: ["*"],
      }),
    );
    ...
    */
    ...
    const securityGroupForVpcConnector = new SecurityGroup(this, "SecurityGroupForVpcConnector", {
      vpc: vpc,
